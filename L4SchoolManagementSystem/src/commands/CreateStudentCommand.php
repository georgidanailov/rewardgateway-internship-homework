...
class CreateStudentCommand implements Command
{
    ...
    public function execute()
    {
        ...
        if (empty($this->subjects)) {
            echo "No subjects assigned to the student.\n";
            return;
        }
        ...
        $student = new Student($this->username, $this->password, $assignedSubjects);
        echo "Student '$this->name' created successfully with subjects: " . implode(', ', $assignedSubjects) . ".\n";
    }
}
